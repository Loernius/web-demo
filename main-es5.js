...
var MenuWhiteComponent = /** @class */ (function () {
    function MenuWhiteComponent() {
    }
    MenuWhiteComponent.prototype.ngOnInit = function () {
    };
...
var HttpClient = /** @class */ (function () {
    function HttpClient(http) {
        ...
        this.obToken = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
    ...
    HttpClient.prototype.isJson = function (str) {
        try {
            JSON.parse(str);
        }
        catch (e) {
    ...
    Object.defineProperty(HttpClient.prototype, "EndPoint", {
        get: function () {
    ...
    HttpClient.prototype.get = function (url) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            _this.obToken.subscribe(function (header) {
                // console.log(this.endPoint)
                _this.http.get(_this.endPoint + url, {
                    headers: header
    ...
    HttpClient.prototype.getReport = function (url) {
        var _this = this;
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            _this.obToken.subscribe(function (header) {
                _this.http.get(_this.endPoint + url, {
    ...
    HttpClient.prototype.getWithParams = function (url, params) {
        var _this = this;
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            _this.obToken.subscribe(function (header) {
                _this.http.get(_this.endPoint + url, {
    ...
    HttpClient.prototype.post = function (url, data, options) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            _this.obToken.subscribe(function (header) {
                ...
                _this.http.post(_this.endPoint + url, data, options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (err) {
                    observer.error(err);
                    throw err;
                }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
                    return response;
    ...
    HttpClient.prototype.put = function (url, data) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            _this.obToken.subscribe(function (header) {
                _this.http.put(_this.endPoint + url, data, {
                    headers: header
                }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (err) {
                    observer.error(err);
                    throw err;
    ...
    HttpClient.prototype.delete = function (url) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            _this.obToken.subscribe(function (header) {
                _this.http.delete(_this.endPoint + url, {
                    headers: header
                }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (err) {
                    observer.error(err);
                    throw err;
...
var AnunciarComponent = /** @class */ (function () {
    function AnunciarComponent(router, http, _http) {
        this.router = router;
        this.http = http;
        this._http = _http;
    }
    AnunciarComponent.prototype.ngOnInit = function () {
        var data = sessionStorage.getItem('login');
        if (!data) {
            this.router.navigate(['login']);
        }
    };
    AnunciarComponent.prototype.buscaCep = function () {
        var _this = this;
        this.http.get("https://viacep.com.br/ws/" + this.cep + "/json/")
            .subscribe(function (data) { return _this.cepJson = data; });
    };
    AnunciarComponent.prototype.doService = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var email;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, sessionStorage.getItem('login')];
                    case 1:
                        email = _a.sent();
    ...
    AnunciarComponent.ctorParameters = function () { return [
...
var CadastroComponent = /** @class */ (function () {
    ...
    CadastroComponent.prototype.doRegister = function () {
        var _this = this;
        if (this.senha != this.resenha) {
            ...
            this.http.post("/user/register", { name: this.nome, email: this.email, password: this.senha })
                ...
                if (data.error) {
                    ...
                    _this.router.navigate(['anunciar']);
                }
            });
        }
    };
...
var SearchComponent = /** @class */ (function () {
    function SearchComponent(route, http) {
        this.route = route;
        this.http = http;
        this.queryParams = {};
        this.barbeiro = false;
    ...
    SearchComponent.prototype.capitalizeFirstLetter = function (string) {
    ...
    SearchComponent.prototype.searchByForm = function () {
        console.log(this.barbeiro, this.pedreiro, this.pintor);
        var filter = { query: this.inputSearch, type: [], city: [] };
        if (this.barbeiro)
    ...
    SearchComponent.prototype.search = function (params) {
        var _this = this;
        if (params === void 0) { params = {}; }
        this.http.post("/service/get", params)
            .subscribe(function (data) {
            var services = data.services;
            services.map(function (service) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
            ...
            _this.servicesList = data.services;
        });
    };
